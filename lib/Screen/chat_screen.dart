...
import 'package:doctor_appoint/widgets/chat_sample.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  String timeOfMessage = TimeOfDay.fromDateTime(DateTime.timestamp()).toString();
  // final timeOfMessage = timeOfMessage.replaceRange(0, 6, '');
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5),
                            Text(
                              TimeOfDay.fromDateTime(DateTime.timestamp()).toString(),
                              // DateFormat('hh:mm a').toString()?? '', // Display time
                              style: TextStyle(
                                color:
